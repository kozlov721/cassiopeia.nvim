...
Highlight('PmenuSel'       , { fg = c.bg0, bg = c.bg_blue      })
Highlight('PmenuThumb'     , { bg =  c.gray                    })
Highlight('Search'         , { fg = c.bg0, bg =  c.bg_green    })
...
Highlight('FloatBorder'     , {fg = c.black , bg = c.bg0        })
...
-- Highlight('TSURI', {fg = c.magenta, gui = 'italic,underline'})
